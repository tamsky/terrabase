...
$(UPSTREAM_ROOT_PREFIX)/terragrunt-local-config.tfvars: $(UPSTREAM_ROOT_PREFIX)/terragrunt-local-config.tfvars.in $(UPSTREAM_ROOT_PREFIX)/terragrunt-s3-config
	cat $(UPSTREAM_ROOT_PREFIX)/terragrunt-s3-config >$@
	cat $(UPSTREAM_ROOT_PREFIX)/terragrunt-local-config.tfvars.in >>$@

$(UPSTREAM_ROOT_PREFIX)/terragrunt-default-config.tfvars: $(UPSTREAM_ROOT_PREFIX)/terragrunt-default-config.tfvars.in $(UPSTREAM_ROOT_PREFIX)/terragrunt-s3-config
	cat $(UPSTREAM_ROOT_PREFIX)/terragrunt-s3-config >$@
